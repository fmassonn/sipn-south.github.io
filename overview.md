...
In parallel, the need for reliable Antarctic sea-ice predictions is increasing rapidly. Tourism in the southern polar regions is booming, and intense observing campaigns are planned within the next few years, including in relationship with the [Antarctica InSync effort](https://www.antarctica-insync.org/) and the [International Polar Year 2032-2033](https://ipy5.info/).

For operational purposes, sea-ice conditions are one of the many challenges that face vessels operating in the Antarctic coastal region. Some parts of the Antarctic are experiencing declining sea-ice extent while other areas are seeing multi‐year sea ice persisting in areas where, previously, that was not the norm. These changing conditions impact on science, science support and logistic operations in those regions. Advance notice of seasonal sea-ice conditions would help reduce costs associated with providing alternative operational logistics.
...
3. Coordinate realistic prediction exercises aligned with community projects, like previously the [Year Of Polar Prediction (YOPP)](https://www.polarprediction.net/)’s Special Observing Periods.
